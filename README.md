...
### Project Goals
- Generate a high-fidelity, ground-truth technical QA dataset.
- Benchmark structured vs. semantic chunking strategies.
- Quantify the performance gap between embedding models in specific 3GPP sub-domains.
